...
// Top navigation bar: hamburger, logo, search, storage, profile menu
// Requires: $size_used, $display_name, $path_foto, $role,
//           $profile_data, $portfolio_url, $current_page, $username,
//           $active_folder, $search_query, $csrf_token
// ============================================================
?>
        ...
        <div class="profile-container">
            ...
            <div id="profileMenu" class="profile-menu">
                ...
                <div class="profile-menu-links">
                    ...
                    <?php if(isSuperAdmin()){?>
                    <a href="index.php?page=manajemen-pengguna" style="color:var(--superadmin);"><i class="fa-solid fa-users-gear"></i> Manajemen User</a>
                    <?php }?>
