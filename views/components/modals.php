<?php
// ============================================================
// views/components/modals.php
// Semua pop-up modal: folder, upload, pindah, settings, user CRUD
// Requires: $csrf_token, $active_folder, $all_users, $all_folders_list,
//           $path_foto, $nama_lengkap, $username, $uid
// ============================================================
?>
...
<!-- FAB (Mobile, hanya tampil saat di dalam folder) -->
...
<!-- HIDDEN FORMS: bulk operations & rename -->
